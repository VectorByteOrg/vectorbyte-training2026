...
## if DL is true, I will download the files from 
## vecdyn directly. Otherwise I will use the saved R files
DL <- FALSE
post2015 <- TRUE
...
```{r, echo=FALSE}
## Here I can load the datasets if I first downloaded
## and then used the "save" function to make the Rsave files
if(DL == FALSE){
  load("mosqDF.Rsave")
