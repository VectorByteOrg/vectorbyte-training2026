...
In this section, we introduce you to a vignette to access ERA 5 that has been aggregated at admin level scales for the globe by projects related to the UK VBD Hub; using this derived dataset obviates the need to acquire and use an API Key from Copernicus. 

Alternately, we will share a link to R code demonstrating how to use API keys in your data queries of Copernicus directly
