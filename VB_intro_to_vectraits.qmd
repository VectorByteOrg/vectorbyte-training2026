...
<center>
![](graphics/Intro_VecTraits_1.jpg)
</center>
...
<center>
![](graphics/Intro_VecTraits_2.jpg)
</center>
...
- Minimum columns required for upload
- These cannot be missing
- Should include all available data
- If a required column is missing, file may fail to upload without and error

::: columns
::: {.column width="50%"}

$\Rightarrow$ Original Trait Value
$\Rightarrow$ Original Trait Unit
$\Rightarrow$ Original ID
$\Rightarrow$ Location
$\Rightarrow$ Location Date Precision
$\Rightarrow$ Submitted By
$\Rightarrow$ Contributor Email
$\Rightarrow$ Citation
$\Rightarrow$ Embargo Release
...
- Must be logged into VectorByte account
<center>
![](graphics/Intro_VecTraits_6.jpg)
</center>
...
- Full taxonomic grouping used in study/paper recorded in ‘interactorx’ column
- This can include information on subspecies, species complex, biotype, etc
- Dedicated columns for taxonomic groupings (Kingdom, Phylum, Class, Order, Family, Genus, Species)
- The ‘interactorxspecies’ column should only contain specific epithet
- Add additional interactors (e.g., interactor2, interactor3…) with associated taxonomy for any other organisms included in study
- These may include pathogens, hosts, and plants
...
<center>
![](graphics/Intro_VecTraits_8a.jpg)
</center>
...
![](graphics/Intro_VecTraits_8b.jpg)

![](graphics/Intro_VecTraits_8c.jpg)
...
VecTraits Leah R. Johnson, Lauren Cator, Samuel S. C. Rund, Sadie Ryan, Paul J. Huxley, and Samraat Pawar. 2023. “VecTraits Explorer.” University of Notre Dame. https://doi.org/10.7274/28020782

The Vector Data EcosystemSadie J. Ryan, Leah R. Johnson, Catherine A. Lippi, Lauren Cator, Samraat Pawar, and Samuel S. C. Rund. 2023. “The Vector Data Ecosystem.” University of Notre Dame. https://doi.org/10.7274/27854508 or Catherine A Lippi, Samuel S C Rund, Sadie J Ryan, Characterizing the Vector Data Ecosystem, Journal of Medical Entomology, Volume 60, Issue 2, March 2023, Pages 247–254 For more info: https://www.vectorbyte.org/blog/how-to-cite-us
